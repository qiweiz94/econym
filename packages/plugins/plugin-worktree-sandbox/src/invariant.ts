/**
 * Package-owned invariant companion for `@econym/dsh-plugin-worktree-sandbox`.
 * @module @econym/dsh-plugin-worktree-sandbox/invariant
 */
...
const PACKAGE_NAME = '@econym/dsh-plugin-worktree-sandbox'
