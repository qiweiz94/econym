/**
 * Package-owned invariant companion for `@econym/dsh-budget-governor`.
 * @module @econym/dsh-budget-governor/invariant
 */
...
const PACKAGE_NAME = '@econym/dsh-budget-governor'
